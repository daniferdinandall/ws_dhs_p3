...
func Web(page *fiber.App) {
	...
	page.Get("/dhs/:npm", controller.GetDHSByNPM)
	...
	page.Get("/mahasiswa/:npm", controller.GetMahasiswaByNPM)
	...
	page.Get("/dosen/:kode", controller.GetDosenByKodeDosen)
	...
	page.Get("/matakuliah/:kode", controller.GetMataKuliahByKodeMataKuliah)
	...
	page.Get("/programstudi/:kode", controller.GetProgramStudiByKodeProgramStudi)
	...
	page.Get("/fakultas/:kode", controller.GetFakultasByKodeFakultas)
